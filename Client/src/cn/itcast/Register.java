...
//			conn.setRequestProperty("accept", "*/*");
			...
			conn.setRequestProperty("emailToken", "bLPJix");
//			conn.setRequestProperty("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
	...
	public static void main(String[] args) {
		...
		jsonObject2.put("usrname", "AceMonster");
		jsonObject2.put("passwd", "123456");
		jsonObject2.put("email", "1157280084@qq.com");
		// 发送 POST 请求
...
//		String sr = Register.sendPost(jsonObject2.toJSONString(), "http://192.168.195.128:8080/user/register"); 
		String sr = Register.sendPost(jsonObject2.toJSONString(), "http://134.175.99.234:8080/user/register"); 
